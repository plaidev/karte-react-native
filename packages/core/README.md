...
React Native KARTE provides native integration of KARTE for both Android & iOS. The React Native KARTE Core module provides a simple JavaScript API for event tracking.
